      ...
      <section className="bg-white/40 dark:bg-[#0a0a0c]/60 backdrop-blur-3xl border border-white/60 dark:border-white/5 rounded-[2.5rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] mb-10 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <textarea value={remarketingTemplate} onChange={e => setRemarketingTemplate(e.target.value)} rows={4} placeholder="Olá {name}! Sentimos sua falta. Você tem {balance} pontos esperando 🎁" className="w-full bg-white/60 dark:bg-zinc-900/50 border border-white/80 dark:border-zinc-800 rounded-2xl p-4 text-slate-800 dark:text-zinc-200 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition placeholder:text-slate-400 dark:placeholder:text-zinc-600" />

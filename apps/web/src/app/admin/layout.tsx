'use client';
import { Home, Settings as SettingsIcon, Sun, Moon, Link as LinkIcon, Award } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex w-full min-h-screen p-4 pl-6 gap-8">
      ...
      <aside className="w-[68px] my-auto bg-[#171717] dark:bg-[#0a0a0c] border border-transparent dark:border-white/5 rounded-full flex flex-col items-center py-8 gap-6 shadow-[0_20px_50px_rgba(0,0,0,0.3)] z-50 h-[300px] sticky top-[calc(50vh-150px)] shrink-0 transition-colors">
